...
import com.zfh.common_utils.ZUtils.getApp
...
class BarUtils private constructor() {
    ...
    companion object {
        ...
        fun setStatusBarColor(
            ...
            val activity: AppCompatActivity? = getActivityByView(fakeStatusBar)
            if (activity == null) {
                return
            }
            transparentStatusBar(activity)
        ...
        private fun applyStatusBarColor(
            ...
            val parent: ViewGroup = (if (isDecor) activity.window
                .decorView as ViewGroup else activity.findViewById<View?>(
                R.id.content
            ) as ViewGroup?)!!
            ...
            get() {
                ...
                if (getApp().theme
                    ...
                    return TypedValue.complexToDimensionPixelSize(
                        tv.data, getApp().resources.displayMetrics
                    )
                }
                return 0
            }
        ...
        private fun invokePanels(methodName: String) {
            try {
                @SuppressLint("WrongConstant") val service = getApp().getSystemService("statusbar")
